                ...
                <div class="col-md-12 col-12">
                    <div class="page-heading text-white">
                        <div class="page-title">
                            <h1>Network and Infrastructure </h1>
                        </div>
                    </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">Network and Infrastructure Services</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 offset-lg-1 col-xl-7 p-lg-0 col-12 order-1 order-lg-2">
                    <div class="service-details-content">
                        ...
                        <h1>Network and Infrastructure Services</h1>
                        <p>We provide end-to-end Network and Infrastructure solutions to ensure smooth and uninterrupted business operations. Our services include Network Design and Implementation, Network Security, Network Management, Infrastructure Design and Implementation, Infrastructure Security, Infrastructure Management, and Disaster Recovery Planning.</p>
