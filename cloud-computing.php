                ...
                <div class="col-md-12 col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">Cloud Computing Services</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 offset-lg-1 col-xl-7 p-lg-0 col-12 order-1 order-lg-2">
                    <div class="service-details-content">
                        ...
                        <h1>Cloud Computing Services</h1>
                        <p>Our certified Cloud DevOps Engineers provide website and app development, deployment, and management services on the cloud. We use industry-leading tools and techniques to ensure that your cloud infrastructure is secure and resilient. Our services include:.</p>
